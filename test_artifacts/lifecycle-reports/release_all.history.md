...
**Started**: 2026-06-03T14:40:06.005Z
**Finished**: 2026-06-03T14:40:19.328Z (duration: 13323ms)
**Result**: ✅ PASS
...
|---|---|---|---|---|---|---|---|
| 1 | `ZSO-VISIBILITY` | `visibility` | …cucebb | [T+0:00:01] | [T+0:00:01] | done | Material rows upserted (count now 3) |
| 2 | `ZLOAD1` | `zload1` | …5urg9h | [T+0:00:10] | [T+0:00:11] | done |  |
| 3 | `ZLOAD3-B1` | `zload3b1` | …tax9kc | [T+0:00:12] | [T+0:00:12] | done | Invoice 7682614520/85817679, Shipment status=shipped |
| 4 | `VTO1N-B` | `vto1n` | …khv1hg | [T+0:00:12] | [T+0:00:12] | done | Shipment status=shipped |
...
```
  [T+0:00:01] ZSO-VISIBILITY   work=…cucebb state=done    → ✓ done at [T+0:00:01]
...
**Driver notes**:
- Inbox pushed: MOCK-NEWORDER-1780497606028 subject="NEW ORDER 3290001"
- checkForNewEmails returned triggered=1 errors=0
- SO created: id=cmpy6ayf20006sxsl8379gu4x poId=cmpy6ayf00004sxslud2pnrl2
- ls_dispatch landed: emailId=cmpy6aymy000osxslbte4zzst
...
```
  ...
  [T+0:00:06] email_sent             dispatch_confirmation to test-branch@example.com
...
**Driver notes**:
- Injecting inbound_reply to email cmpy6aymy000osxslbte4zzst (type=ls_dispatch)
...
**SAP transactions this step**:
```
  [T+0:00:10] ZLOAD1           work=…5urg9h state=firing  → (firing)
```

**New scenario events**:
```
  [T+0:00:06] email_received         dispatch_confirmation from branch
...
**New scenario events**:
```
  [T+0:00:11] email_sent             vehicle_details to test-branch@example.com
  [T+0:00:11] step_completed         zload1 ✓
  [T+0:00:11] step_fired             email_to_branch_for_vehicle
  [T+0:00:11] step_completed         email_to_branch_for_vehicle ✓
...
**Driver notes**:
- vehicle_details email found after 403ms
...
**SAP transactions this step**:
```
  [T+0:00:12] ZLOAD3-B1        work=…tax9kc state=done    → ✓ done at [T+0:00:12]
...
**Driver notes**:
- Shipment found id=cmpy6b6zw002usxslo2b7bz30 status=created obd=85817679
...
**SAP transactions this step**:
```
  [T+0:00:12] VTO1N-B          work=…khv1hg state=done    → ✓ done at [T+0:00:12]
...
**Driver notes**:
- Firing triggerVto1n on Shipment cmpy6b6zw002usxslo2b7bz30
...
[T+0:00:00] email_sent           ls_dispatch to test-branch@example.com — "Dispatch Approval Request - PO AUTO-MOCK-NEWORDER-178049760…"
[T+0:00:00] step_completed       zso_visibility ✓
[T+0:00:00] email_received       from branch — Subject "Dispatch Approval Request - PO AUTO-MOCK-NEWORDER-178049760…" — "Please release everything as available. All quantities approved, go ahead and d…"
...
[T+0:00:04] email_sent           dispatch_confirmation to test-branch@example.com — "Dispatch Confirmation - PO AUTO-MOCK-NEWORDER-1780497606028"
[T+0:00:04] step_completed       email_confirm_bundle_details ✓
[T+0:00:04] scenario_completed   llm-planned
[T+0:00:05] email_received       from branch — Subject "Dispatch Confirmation - PO AUTO-MOCK-NEWORDER-1780497606028" — "Yes, please proceed with the dispatch plan as confirmed. Go ahead."
[T+0:00:09] classifier_decision  llm-planned
[T+0:00:09] scenario_started     llm-planned
[T+0:00:09] step_fired           zload1
[T+0:00:10] email_sent           vehicle_details to test-branch@example.com — "Vehicle Details Required - PO AUTO-MOCK-NEWORDER-1780497606…"
[T+0:00:10] step_completed       zload1 ✓ — LS 373284:PENDING=?, 373283:PENDING=?, 373282:PENDING=?
...
[T+0:00:10] email_sent           plant_ls to test-plant@example.com — "Loading Slip 373282 - SO 3290001"
[T+0:00:10] email_sent           plant_ls to test-plant@example.com — "Loading Slip 373283 - SO 3290001"
[T+0:00:10] email_sent           plant_ls to test-plant@example.com — "Loading Slip 373284 - SO 3290001"
[T+0:00:11] step_completed       zload3b1 ✓
[T+0:00:11] step_completed       vto1n ✓
```

## Complete email thread (chronological)

```
--- Turn 1 [2026-06-03T14:40:07.643Z] US → test-branch@example.com [type=ls_dispatch] ---
Subject: Dispatch Approval Request - PO AUTO-MOCK-NEWORDER-1780497606028
Dispatch Recommendation - AUTO-MOCK-NEWORDER-1780497606028 Dear Sales Team, Sales Order 3290001 I have reviewed the stock availability for Sales Order 3290001. Here is the dispatch recommendation: Material A — APJP [YE1EDWO00001APJP] : Stock is confirmed available. Proceed with 50 units from Batch A-26. Material B — PJP [YV6FRYENE0000PJP] : Stock is confirmed available. Proceed with 100 units from Batch 30-07-2025. Material C — 43P [YA4COWOCR000043P] : Stock is confirmed available. Proceed with 250 units from Batch 20. Best regards, Sales Order Dispatch Co-ordinator

--- Turn 2 [2026-06-03T14:40:07.941Z] test-branch@example.com → US [type=ls_dispatch] ---
Subject: Re: Dispatch Approval Request - PO AUTO-MOCK-NEWORDER-1780497606028
Please release everything as available. All quantities approved, go ahead and dispatch.

--- Turn 3 [2026-06-03T14:40:12.088Z] US → test-branch@example.com [type=dispatch_confirmation] ---
Subject: Dispatch Confirmation - PO AUTO-MOCK-NEWORDER-1780497606028
Dear Branch Team, Dispatch plan ready for Purchase Order AUTO-MOCK-NEWORDER-1780497606028 (Chain release_all). Total 10.665 t — fits in 1 vehicle (capacity 35 t). Proposed dispatch (grouped by bundle): Bundle 1 — 10.665 t (of 35 t capacity): - SO 3290001 / YA4COWOCR000043P (Batch 20): 250 units, 6.625 t - SO 3290001 / YE1EDWO00001APJP (Batch A-26): 50 units, 1.320 t - SO 3290001 / YV6FRYENE0000PJP (Batch 30-07-2025): 100 units, 2.720 t Please reply with: - "yes" / "confirm" to proceed with the above plan, or - the changes you want (e.g. "skip OOWJ on SO 1234567", "send only 15 of OP7WJ"). Once confirmed we will create the loading slips. Best regards, Sales Order Dispatch Co-ordinator

--- Turn 4 [2026-06-03T14:40:12.599Z] test-branch@example.com → US [type=dispatch_confirmation] ---
Subject: Re: Dispatch Confirmation - PO AUTO-MOCK-NEWORDER-1780497606028
Yes, please proceed with the dispatch plan as confirmed. Go ahead.

--- Turn 5 [2026-06-03T14:40:17.422Z] US → test-branch@example.com [type=vehicle_details] ---
Subject: Vehicle Details Required - PO AUTO-MOCK-NEWORDER-1780497606028 (1 bundle)
Dear Branch Team, Loading slips for Purchase Order AUTO-MOCK-NEWORDER-1780497606028 are now ready in SAP. The PO is split into 1 bundle: Bundle 1 (~10.66 t): - SO 3290001 / LS 373282 / Material PENDING - SO 3290001 / LS 373283 / Material PENDING - SO 3290001 / LS 373284 / Material PENDING Please reply with vehicle/transport details for each bundle in the format below: Bundle 1: , , Best regards, Sales Order Dispatch Co-ordinator

--- Turn 6 [2026-06-03T14:40:17.707Z] test-branch@example.com → US [type=vehicle_details] ---
Subject: Re: Vehicle Details Required - PO AUTO-MOCK-NEWORDER-1780497606028 (1 bundle)
Vehicle GJ12-XY1234, driver mobile 9876543210, container CONT-TEST-001, LR LR-9988 dated 2026-05-30.

--- Turn 7 [2026-06-03T14:40:18.246Z] test-plant@example.com → US [type=plant_ls] ---
Subject: Re: Loading Slip 373282 - SO 3290001
Plant invoice attached. Invoice 7682614520, OBD 85817679.

--- Turn 8 [2026-06-03T14:40:18.249Z] test-plant@example.com → US [type=plant_ls] ---
Subject: Re: Loading Slip 373283 - SO 3290001
Plant invoice attached. Invoice 7682614520, OBD 85817679.

--- Turn 9 [2026-06-03T14:40:18.250Z] test-plant@example.com → US [type=plant_ls]   ← LATEST INBOUND (plan for THIS) ---
